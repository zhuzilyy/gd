 ...
 * <p>创建时间：2020/5/11
 */
public class SearchTaskAdapter extends BaseRecyclerViewAdapter<WaitingHandleTaskModel> {
    /**
     * @param context  {@link Context}
     * @param list     数据集合
     * @param layoutId RecyclerView item布局ID
     */
    public SearchTaskAdapter(Context context, List<WaitingHandleTaskModel> list, int layoutId) {
