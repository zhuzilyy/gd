 ...
 * <p>创建时间：2020/5/11
 */
public class NoApproveAdapter extends BaseRecyclerViewAdapter<NoApproveModel> {
    /**
     * @param context  {@link Context}
     * @param list     数据集合
     * @param layoutId RecyclerView item布局ID
     */
    public NoApproveAdapter(Context context, List<NoApproveModel> list, int layoutId) {
        super(context, list, layoutId);
    }

    @Override
    protected void bindData(BaseViewHolder viewHolder, NoApproveModel model, int position) {
