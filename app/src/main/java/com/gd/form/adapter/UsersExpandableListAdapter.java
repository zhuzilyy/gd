...
import com.gd.form.demo.OnGroupExpandedListener;
...
public class UsersExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public UsersExpandableListAdapter(String[] groupData, String[][] childData) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            groupViewHolder.btn_update = (Button) convertView.findViewById(R.id.bt_update);
        ...
        groupViewHolder.btn_update.setOnClickListener(v -> ToastUtil.show(groupData[groupPosition]+"修改"));
