 ...
 * <p>创建时间：2020/5/11
 */
public class OtherListAdapter extends BaseRecyclerViewAdapter<SearchOtherModel> {
    /**
     * @param context  {@link Context}
     * @param list     数据集合
     * @param layoutId RecyclerView item布局ID
     */
    public OtherListAdapter(Context context, List<SearchOtherModel> list, int layoutId) {
        super(context, list, layoutId);
    }

    @Override
    protected void bindData(BaseViewHolder viewHolder, SearchOtherModel model, int position) {
