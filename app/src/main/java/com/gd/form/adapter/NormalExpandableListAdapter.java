...
public class NormalExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View
        ...
        if (convertView == null) {
           ...
           // groupViewHolder.bt_del = (Button) convertView.findViewById(R.id.bt_del);
            convertView.setTag(groupViewHolder);
        } else {
            groupViewHolder = (GroupViewHolder) convertView.getTag();
        }
        groupViewHolder.tvTitle.setText(groupData[groupPosition]);
//        groupViewHolder.bt_del.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                ToastUtil.show(groupData[groupPosition]+"删除");
//            }
//        });
        return convertView;
    }
