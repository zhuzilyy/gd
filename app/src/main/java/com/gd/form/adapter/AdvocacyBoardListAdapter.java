 ...
 * <p>创建时间：2020/5/11
 */
public class AdvocacyBoardListAdapter extends BaseRecyclerViewAdapter<PreModel> {
    /**
     * @param context  {@link Context}
     * @param list     数据集合
     * @param layoutId RecyclerView item布局ID
     */
    public AdvocacyBoardListAdapter(Context context, List<PreModel> list, int layoutId) {
        super(context, list, layoutId);
    }

    @Override
    protected void bindData(BaseViewHolder viewHolder, PreModel model, int position) {
