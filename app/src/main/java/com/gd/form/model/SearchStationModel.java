...
public class SearchStationModel {
    ...
    public String getStandardeep() {
        return standardeep;
    }

    public void setStandardeep(String standardeep) {
        this.standardeep = standardeep;
    }
    ...
    public String getManpile() {
        return manpile;
    }

    public void setManpile(String manpile) {
        this.manpile = manpile;
    }
