 ...
 * <p>类描述：底部列表弹窗
 */
public class ListLandTagDialog extends Dialog {
    ...
    public ListLandTagDialog(Context context) {
        super(context);
        init(context);
    }
    private void init(Context context) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        mRootView = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.dialog_list_land_tag, null, false);
        setContentView(mRootView);
        dialogRecyclerView = mRootView.findViewById(R.id.recyclerView);
    ...
    public void dismiss() {
        ...
        slideToDown(() -> {
            isAnimation = false;
            ListLandTagDialog.super.dismiss();
        });
    }
