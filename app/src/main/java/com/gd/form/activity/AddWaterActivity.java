...
public class AddWaterActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        token = (String) SPUtil.get(AddWaterActivity.this, "token", "");
        userId = (String) SPUtil.get(AddWaterActivity.this, "userId", "");
        if (getIntent() != null) {
    ...
    private void addWaterProtect() {
        ...
        if (!TextUtils.isEmpty(waterProtect)) {
            params.addProperty("waterprotect", waterProtect + ";" +etName.getText().toString());
        } else {
            params.addProperty("waterprotect", etName.getText().toString());
        }
