...
import com.gd.form.adapter.StationStakeAdapter;
...
public class StationStakeActivity extends BaseActivity {
    ...
    private List<TestStakeModel> stationNoModelList;
    private StationStakeAdapter adapter;
    ...
    private void initData() {
        ...
        adapter = new StationStakeAdapter(mContext, stationNoModelList, R.layout.adapter_item_station);
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClickListener(View v, int position) {
                ...
                intent.putExtra("lineId", stationNoModelList.get(position).getLineid() + "");
    ...
    private void getData(String keyWord) {
        ...
        Net.create(Api.class).getStakes(token, jsonObject)
                .enqueue(new NetCallback<List<TestStakeModel>>(this, true) {
                    @Override
                    public void onResponse(List<TestStakeModel> list) {
